...
CODE = os.environ.get('DICT', 'stc')
# (suffix, outfile, doc title, page-word, src-word) ; the source-language base ('.md') is the French edition
LANGS = {
  'src': ('.md',    f'{CODE}pref_all.fr.md', 'Matières liminaires — complet (français, langue source)', 'Page',      'Source'),
