...
- Recorded the current repository purpose: Development and correction repository for N.

### Recent Git History
- 2026-05-16 docs(cff): enrich with publication-year + author from inventory (1932, Stchoupak)
